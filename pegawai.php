...
<div class="container mt-3">
    ...
    <?php if (isset($_GET['pesan'])): ?>
        <div class="alert alert-success alert-dismissible fade show">
            <?php 
            if ($_GET['pesan'] == 'tambah') echo "✅ Data guru pegawai ditambahkan!";
            if ($_GET['pesan'] == 'edit') echo "✅ Data guru pegawai diperbaharui!";
            if ($_GET['pesan'] == 'hapus') echo "✅ Data guru pegawai dihapus!";
            ?>
